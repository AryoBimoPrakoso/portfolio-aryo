...
const Navbar = ({ setIndex }) => {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 px-[30px] md:px-[100px] bg-[#f6f6f6] lg:h-[100px] md:h-[130px] h-[70px] w-[425px] md:w-full lg:w-full z-[1000] flex items-center justify-between transition-shadow duration-300 ${shadow ? 'shadow-lg' : ''}`}>
